...
// const taskList =document.querySelector('.modal')
const openModalTr = document.querySelectorAll('[data-modal-target]');
const closeModalButtons = document.querySelectorAll('[data-close-button]');
const overlay = document.getElementById('overlay');

openModalTr.forEach(tr => {
tr.addEventListener('click',() => {
    const modal = document.querySelector(tr.dataset.modalTarget);
    openModal(modal, tr.querySelector('th').innerHTML);
});
});
...
function openModal(modal, el){
    ...
    // console.log(el);
    let element = elements.filter(elem => el === elem.symbol)
    document.getElementById('Name').innerHTML =element[0].name;
    // document.getElementById('Atomi-Number').innerHTML =element[0].atomic_number;
    document.getElementById('Atomic-Mass').innerHTML =element[0].atomic_mass;
